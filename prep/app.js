...
// giving them unique filenames is what actually separates their progress.
const RENAMED_FROM = { 'argus-prep.html': 'index.html' };
...
function loadReviewed() {
  ...
  if (raw == null && RENAMED_FROM[PAGE]) {
    ...
    if (moved != null) { safeSet(STORE_KEY, moved); raw = moved; }
  }
  if (raw == null) {
